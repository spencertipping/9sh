...
9sh borrows ideas from Plan 9, Haskell, SQL, and Self, and is written as a statically-linked binary in C++ with embedded LuaJIT. It uses Fennel, a Clojure-flavored Lisp for Lua, as its scripting language.
